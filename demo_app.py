...
with st.echo(code_location='below'):
    ...
    st.write(
        "Данный график показывает множество интересных зависимостей. Во первых, чтобы было понятнее, размер шарика на графике показывает его длительность, распределены шарики в соотсветствии со своим годом выпуска и рейтингом. Чтобы узнать, конкретный период или инетерсующий вас разброс"
    ...
    #
    st.title("Жанры и актерыheroku create your-app-name --buildpack heroku/python")
    st.write(
